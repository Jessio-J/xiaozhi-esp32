 ...
 * Size: 14 px
 * Bpp: 1
 * Opts: --force-fast-kern-format --no-compress --no-prefilter --font NotoSansThai-Regular.ttf --format lvgl --lv-include lvgl.h --bpp 1 -o src/font_thai_14_1.c --size 14 -r 0x20-0x7F --symbols •·÷×©¥®฀กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู฻฼฽฾฿เแโใไๅๆ็่้๊๋์ํ๎๏๐๑๒๓๔๕๖๗๘๙๚๛๜๝๞๟๠๡๢๣๤๥๦๧๨๩๪๫๬๭๮๯๰๱๲๳๴๵๶๷๸๹๺๻๼๽๾๿
 ******************************************************************************/
...
#ifndef FONT_THAI_14_1
#define FONT_THAI_14_1 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_thai_14_1 = {
#else
lv_font_t font_thai_14_1 = {
#endif
